...
class TtlEvaluatorTest {
  ...
  void shouldNotBeBreached_WhenDeadlineNotYetReached() {
    ...
    assertThat(TtlEvaluator.isBreached(expectedBefore, new SafeguardProperties(false, 0L)))
        .isFalse();
  }
  ...
  void shouldBeBreached_WhenDeadlineHasPassedAndSafeguardDisabled() {
    ...
    assertThat(TtlEvaluator.isBreached(expectedBefore, new SafeguardProperties(false, 999L)))
        .isTrue();
  }
  ...
  void shouldBeBreached_WhenSafeguardEnabledButOffsetDoesNotCoverTheGap() {
    ...
    assertThat(TtlEvaluator.isBreached(expectedBefore, new SafeguardProperties(true, 10L)))
        .isTrue();
  }
  ...
  void shouldNotBeBreached_WhenSafeguardOffsetKeepsDeadlineInFuture() {
    ...
    assertThat(TtlEvaluator.isBreached(expectedBefore, new SafeguardProperties(true, 60L)))
        .isFalse();
  }
}
